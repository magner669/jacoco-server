...
class SessionTest {
    ...
    @Mock
    private ISessionInfoVisitor iSessionInfoVisitor;
    @Captor
    private ArgumentCaptor<SessionInfo> sessionInfoCaptor;
    ...
    class ExecutionDataTests {
        @Mock
        private IExecutionDataVisitor iExecutionDataVisitor;
        @Mock
        private ExecutionData executionData;
        @Mock
        private ExecutionData otherExecutionData;
