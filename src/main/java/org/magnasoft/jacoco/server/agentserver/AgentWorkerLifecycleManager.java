 ...
 *
 * <p>The {@link #accept(Socket)} method is called with a new TCP connection from a JaCoCo agent.
 *
 * <p>It delegates to {@link SessionStateManager} to deal with the JaCoCo execution data and session
 * information,and will then build a {@link AgentWorker} to handle the connection and run it in a
 * virtual thread.
 */
@Service
